...
#define STRING_CONFIG_H_AUTHOR "(Guana-Banana)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10 SKR MINI V3.0"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Below - ElPrinto values
  #define DEFAULT_bedKp 76.32
  #define DEFAULT_bedKi 13.5
  #define DEFAULT_bedKd 289
