...
#define STRING_CONFIG_H_AUTHOR "(Guana-bananas)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "El Printo 5.0"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 14.0f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.0941f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0584f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Below - ElPrinto values
  #define DEFAULT_bedKp 78.1
  #define DEFAULT_bedKi 13.95
  #define DEFAULT_bedKd 291.8
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 650, 650, 20, 50 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 650, 650, 100, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -4, -3.19 }
 ...
 */
#define Z_PROBE_END_SCRIPT "G1 X20 Y0.5 Z10 F7500"
